...
},{"base64-js":"../../node_modules/base64-js/index.js","ieee754":"../../node_modules/ieee754/index.js","isarray":"../../node_modules/buffer/node_modules/isarray/index.js","buffer":"../../node_modules/buffer/index.js"}],"../../node_modules/fclone/dist/fclone.js":[function(require,module,exports) {
var define;
...
var link = (0, _apolloLink.split)( // split based on operation type
function (_ref) {
...
},{"graphql/language/parser":"../../node_modules/graphql/language/parser.js"}],"../../node_modules/lit-html/lib/directive.js":[function(require,module,exports) {
"use strict";
...
var GET_USERS = (0, _graphqlTag.default)(_templateObject());
var USER_LIST_SUBSCRIBE = (0, _graphqlTag.default)(_templateObject2());

var userListTemplate = function userListTemplate(users) {
  return (0, _litHtml.html)(_templateObject3(), users.map(function (i) {
    return (0, _litHtml.html)(_templateObject4(), i.id, i.name, i.email);
  }));
};

var userListRender = function userListRender(target) {
  _client.default.query({
    query: GET_USERS,
    fetchPolicy: 'no-cache'
  }).then(function (res) {
    var users = res.data.users;
    (0, _litHtml.render)(userListTemplate(users), target);
  });
};

var _default = function () {
  var target = document.querySelector('user-list'); // initially call userListRender

  userListRender(target); // then subscribe to any changes

  var subscription = _client.default.subscribe({
    query: USER_LIST_SUBSCRIBE
  });
...
exports.default = _default;
},{"./client":"client.js","graphql-tag":"../../node_modules/graphql-tag/src/index.js","lit-html":"../../node_modules/lit-html/lit-html.js"}],"track-position.js":[function(require,module,exports) {
"use strict";
...
require("./track-position");
},{"./user-list":"user-list.js","./track-position":"track-position.js"}],"../../node_modules/parcel-bundler/src/builtins/hmr-runtime.js":[function(require,module,exports) {
var global = arguments[3];
